...
<div style="font-size: 13px; width: 300px; height: 30px;">Key buffer: <pre id="command-display"></pre></div>
...
implementation</p>
    ...
    <script>
      ...
      CodeMirror.on(editor, 'vim-keypress', function(key) {
        ...
        keys = keys + key;
        commandDisplay.innerHTML = escape(keys);
      });
      ...
      // CodeMirror.Vim.map("<Space>", "<PageDown>", "normal");
      CodeMirror.Vim.map("jkl", "<PageUp>", "normal");
      CodeMirror.Vim.unmap("<Space>", undefined);
      CodeMirror.Vim.map("<Space>b", "<PageDown>", "normal");
    </script>
